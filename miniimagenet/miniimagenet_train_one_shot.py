...
#     if os.path.exists(str("./models2/miniimagenet_feature_encoder1_" + str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl")):
#         feature_encoder.load_state_dict(torch.load(str("./models2/miniimagenet_feature_encoder1_" + str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl")))
#         print("load feature encoder success")
#     if os.path.exists(str("./models2/miniimagenet_relation_network1_"+ str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl")):
#         relation_network.load_state_dict(torch.load(str("./models2/miniimagenet_relation_network1_"+ str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl")))
    ...
    for episode in range(EPISODE):
        ...
        if episode%1000 == 0:
            ...
            if test_accuracy > last_accuracy:
                ...
                # save networks
                torch.save(feature_encoder.state_dict(),str("./miniimagenet_feature_encoder1_" + str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl"))
                torch.save(relation_network.state_dict(),str("./miniimagenet_relation_network1_"+ str(CLASS_NUM) +"way_" + str(SAMPLE_NUM_PER_CLASS) +"shot.pkl"))
